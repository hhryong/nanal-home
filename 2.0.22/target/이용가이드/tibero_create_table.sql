...
CREATE TABLE APP_SEND_DATA (
  ...
  CONSTRAINT APP_SEND_DATA_PK PRIMARY KEY (MSG_SEQ)
)
...
CREATE TABLE APP_SEND_CONTENTS (
  ...
  CONSTRAINT APP_SEND_CONTENTS_PK PRIMARY KEY (PACK_UNIQUEKEY)
)
...
CREATE TABLE TEMPLATE_CODE (
  ...
  CONSTRAINT TEMPLATE_CODE_PK PRIMARY KEY (APP_GUBUN, TEMPLATE_CODE)
)
