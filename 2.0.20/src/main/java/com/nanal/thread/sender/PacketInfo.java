...
public class PacketInfo {
	public static final String serverVersion = "2.0.0:000020"; // 앞에 2개 숫자는 서버 버전, 그 이후는 클라이언트 버전
	public static final String displayVersion = "2.0.20"; // 앞에 2개 숫자는 서버 버전, 그 이후는 클라이언트 버전
