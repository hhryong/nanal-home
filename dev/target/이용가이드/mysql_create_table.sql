...
CREATE TABLE IF NOT EXISTS APP_SEND_DATA
(
	MSG_SEQ 		             INT AUTO_INCREMENT 	NOT NULL,   -- 메시지 순번
...
CREATE TABLE IF NOT EXISTS APP_SEND_CONTENTS
(
    REQ_SEND_DATE CHAR(14),  -- 메시지 발송 일시
    PACK_UNIQUEKEY INT NOT NULL,  -- 순번
